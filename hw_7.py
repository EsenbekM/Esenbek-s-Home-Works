...
█████▀░░░░▀▀████████░░
            ...
            a.write(f'You start in: {time_s.strftime("%X")} \n')
            a.write(f'You finish in: {datetime.datetime.now().strftime("%X")} \n')
            a.write(f'You choose {tr} attempts\nGuessed in {count} attempts! \nYour time - {time_f.seconds} seconds \n')
            break
